            ...
            <div className="container mx-auto px-4 py-8 max-w-6xl">
                ...
                {novels.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                        {novels.map((novel) => (
                            <article
                                key={novel.slug}  // Moved key here from the inner article
                                className="group border rounded-xl p-6 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors shadow-sm hover:shadow-md relative"
                            >
                                <a
                                    href={`/wn/${novel.slug}`}
                                ...
                                >
                                    <span className="sr-only">View {novel.title}</span>
                                </a>
