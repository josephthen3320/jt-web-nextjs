import { FaFolder, FaRegFolder, FaEnvelope, FaGithub, FaFacebook, FaInstagram, FaYoutube, FaExternalLinkAlt } from "react-icons/fa";
import { FaAward } from "react-icons/fa";

const Card = ({
                  title, description, award, imgSrc, href, github, youtube, tech }: any) => (
                        ...
                        {youtube && (
                            <div className="mx-1.5">
                                <a
                                    ...
                                    rel="noopener noreferrer"
                                >
                                    <FaYoutube className="text-2xl text-gray-500 transition duration-200 hover:rotate-180 hover:text-blue-400" />
                                </a>
                            </div>
                        )}
                    </div>
