                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                {post.tags
                                    ...
                                    .map((tag: string, index: Key | null | undefined) => (
                                        <span
                                            key={index}
                                            className="mr-2 rounded-lg border border-pink-600 py-1 px-3 text-sm font-medium text-pink-600 uppercase transition duration-500 ease-in-out hover:bg-pink-600 hover:text-gray-100 dark:hover:text-gray-900"
                                        >
